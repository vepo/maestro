...
import static dev.vepo.maestro.parser.model.Expression.and;
import static dev.vepo.maestro.parser.model.Expression.eq;
import static dev.vepo.maestro.parser.model.Expression.gt;
import static dev.vepo.maestro.parser.model.Expression.in;
import static dev.vepo.maestro.parser.model.Expression.lt;
import static dev.vepo.maestro.parser.model.Expression.not;
import static dev.vepo.maestro.parser.model.Expression.or;
import static dev.vepo.maestro.parser.model.Expression.parenthesis;
import static dev.vepo.maestro.parser.model.Literal.number;
import static dev.vepo.maestro.parser.model.Literal.string;
